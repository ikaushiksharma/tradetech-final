  ...
  return (
    ...
    >
      <Image
        ...
        alt="full text"
        className="isolate w-[35%] drop-shadow-lg absolute top-[26%] left-[14%]"
      />
      <Image
        src={item2}
        style={{ transform: 'translateZ(40px)' }}
        alt="full text"
        className="isolate w-[35%] drop-shadow-lg absolute top-[40%] right-[14%]"
      />
      <Image
        src={item3}
        style={{ transform: 'translateZ(40px)' }}
        alt="full text"
        className="isolate w-[35%] drop-shadow-lg absolute bottom-[24%] left-[14%]"
      />
      <Image
        src={item4}
        style={{ transform: 'translateZ(40px)' }}
        alt="full text"
        className="isolate w-[35%] drop-shadow-lg absolute bottom-[24%] right-[14%]"
      />
    </Tilt>
  )
}
