...
const HeroSection = (props: Props) => {
  return (
    <div className="h-screen px-16 relative mx-auto flex flex-col pt-40 items-center ">
      <div>
        <h1 className="text-5xl mx-auto max-w-2xl uppercase text-center">
        ...
        <div className="w-3/4 flex items-center justify-center absolute left-1/2 transform -translate-x-1/2 z-[-1]">
