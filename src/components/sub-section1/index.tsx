      ...
      <div className="w-full relative px-16 container flex items-center justify-center h-screen">
        ...
        <h1 className="text-xl mx-auto max-w-2xl text-center text-gray-500 hidden text1">
          ...
          <p className="my-4">
            ...
            sales coaches like Ted McGrath will take your material and train
            your AI to become the perfect addition to your team.
          </p>{' '}
        </h1>
        <h1 className="text-xl max-w-2xl text-center text-gray-500 hidden text2">
          ...
          <p className="my-4">
            Our AI acts as a member of your team following your sales strategy
            and using your business language to better communicate with your
            clients
          </p>
        </h1>
      </div>
