...
const FeaturesSection2 = () => {
  return (
    <div className="max-w-screen-2xl relative gap-12 mt-12 bg-gray-100 p-16 w-full flex flex-col items-center min-h-screen h-full">
      <div className="max-w-xl text-3xl md:text-6xl mb-12 font-bold">
        <h1 className="text-center">
          Seamlessly enhance your current sales strategy
        </h1>
        <h2 className="text-center mt-4 text-[#7E30E1]">Features &gt;</h2>
      </div>
      <div className="flex flex-col md:flex-row items-center w-full md:w-4/5 gap-6 justify-between">
        <div className="flex-[1] flex flex-col gap-6 h-[60vh] py-12 px-8 rounded-3xl bg-white">
          <h3 className="text-2xl font-bold md:whitespace-nowrap">
        ...
        <div className="flex-[2] h-[60vh] rounded-3xl py-12 px-8 bg-gradient-to-r from-purple-200 via-purple-400 to-purple-600">
      ...
      <div className="flex flex-col md:flex-row items-center w-full md:w-4/5 gap-6 justify-between">
        <div className="flex-[2] h-[60vh] rounded-3xl py-12 px-8 bg-white">
          <div className="md:w-3/5 flex flex-col gap-6 ">
            <h3 className="text-2xl font-bold md:whitespace-nowrap">
        ...
        <div className="flex-[1] flex flex-col gap-6 h-[60vh] py-12 px-8 rounded-3xl bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500">
          <h3 className="text-2xl text-white font-bold md:whitespace-nowrap">
            Robust security
          </h3>
