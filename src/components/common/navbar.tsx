...
const Navbar = () => {
  return (
    <>
      <div className="hidden sm:flex max-md:px-4 max-w-screen-2xl border-b border-white z-50 backdrop-blur-lg h-20 w-full justify-center items-center">
        <div className="flex justify-between max-w-screen-xl items-center h-full w-full">
          ...
          <ul className="flex py-2 text-sm flex-[1] flex-grow justify-evenly">
