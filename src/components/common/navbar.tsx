...
const Navbar = () => {
  return (
    <div className="my-12 fixed flex max-w-screen-xl h-12 w-full justify-between items-center">
      <div className="flex justify-between items-center h-full w-full">
        ...
        <ul className="flex flex-[1] flex-grow justify-evenly">
        ...
        <div className="flex-[1] justify-end gap-4 items-center flex">
          <SocialButton
            logo={
              <svg
                width="24"
